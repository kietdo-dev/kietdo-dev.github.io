import { ProjectProps, WorkExperienceProps } from "@src/interfaces/data"
import { FeaturedProjectsResponse, WorkExperienceResponse } from "@src/interfaces/notion"
...
export const useData = () => {
  return useQuery({
    ...
    select: (data) => {
      return {
        About: data.About.results[0].properties.Description.rich_text[0].text.content,
        ...
        FeaturedProjects: data.FeaturedProjects.results.map((project) => {
          ...
          return {
            ...
            techStack: result.properties.TechStack.rich_text[0].text.content.split(", "),
          } as ProjectProps
        })
      }
    },
